...
// webDevPricingData dihapus dari import karena menggunakan database Supabase
...
export default function WebDevPricingPage() {
  ...
  // Filter agar "Web Development" tidak muncul di "Explore Other Services"
    ...
    const fetchPricing = async () => {
      try {
        ...
        const { data, error } = await supabase
          ...
          .select("*")
          .eq("service_type", "WEB DEVELOPMENT") // Pastikan Tipe Layanan sesuai
  ...
  return (
    <main className="min-h-screen pt-10">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {/* Grid 4 Kolom Pricing (Data Dinamis dari Supabase) */}
            ...
            pricingData.map((plan) => (
              <div 
                ...
                className={cn(
                  ...
                  plan.is_pro // Diubah menjadi is_pro sesuai database
